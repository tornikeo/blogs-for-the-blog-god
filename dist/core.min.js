!(function () {
  ...
  class e {
    ...
    async postAutocomplete(A) {
      const e = this.path(`autocomplete/${A.model_size || ""}`),
        t = await fetch(e, {
          method: "POST",
    ...
    async postWithSettings(A) {
      const e =
          document.querySelector(
            ".decoder-settings .setting.model_size .js-val"
          ).textContent || void 0,
        t = (A) => {
        ...
        l = (
          document.querySelector(
            ".decoder-settings input[name=bow_or_discrim]:checked"
          ) || {}
        ).value,
        Q = (
          document.querySelector(
            ".decoder-settings input[name=use_sampling]"
          ) || {}
        ).checked;
  ...
  class t {
    constructor(A) {
      (this.quill = A),
        ...
        A.keyboard.addBinding(
          { key: t.Keys.ENTER },
          this.selectHandler.bind(this)
        ),
        A.keyboard.bindings[t.Keys.ENTER].unshift(
          A.keyboard.bindings[t.Keys.ENTER].pop()
        ),
        A.keyboard.addBinding(
          { key: t.Keys.ESCAPE },
    ...
    highlightItem(A = !0) {
      ...
      if ((e[this.itemIndex].classList.add("selected"), A)) {
        ...
        t < r
          ? (this.mentionContainer.scrollTop = t)
          : t > n - A && (this.mentionContainer.scrollTop += t - n + A);
      }
    }
    getItemData() {
      ...
      return (
        void 0 !== e &&
          (A.dataset.value = `<a href="${e}" target=${
            t || this.options.linkTarget
          }>${A.dataset.value}`),
        A.dataset
      );
    }
    ...
    insertItem(A) {
      ...
      if (null !== e) {
        if (
          (this.options.showDenotationChar || (e.denotationChar = ""),
        ...
        this.quill.insertText(
          ...
          this.quill.setSelection(this.cursorPos + e.value.length, 0),
          this.setCursorPos(),
          this.hideMentionList();
      }
    }
    ...
    onItemClick(A) {
      A.stopImmediatePropagation(),
        A.preventDefault(),
        (this.itemIndex = Number(A.currentTarget.dataset.index)),
        this.highlightItem(),
        this.selectItem();
    }
    attachDataValues(A, e) {
      for (const [t, r] of Object.entries(e))
        this.options.dataAttributes.includes(t)
          ? (A.dataset[t] = r)
          : delete A.dataset[t];
      return A;
    }
    ...
    containerBottomIsNotVisible(A, e) {
      return (
        A + this.mentionContainer.offsetHeight + e.top >
    ...
    containerRightIsNotVisible(A, e) {
      ...
      return (
        A + this.mentionContainer.offsetWidth + e.left >
        window.pageXOffset + document.documentElement.clientWidth
      );
    }
    setIsOpen(A) {
      this.isOpen !== A &&
        (A ? this.options.onOpen() : this.options.onClose(), (this.isOpen = A));
    }
      ...
      if ("top" === this.options.defaultMenuOrientation) {
        if (
          (r = this.options.fixMentionsToQuill
            ? -1 * (t + this.options.offsetTop)
            : e.top - (t + this.options.offsetTop)) +
            A.top <=
          0
        ) {
          let t = this.options.offsetTop;
          this.options.fixMentionsToQuill ? (t += A.height) : (t += e.bottom),
            (r = t);
        }
      } else if (
        (this.options.fixMentionsToQuill ? (r += A.height) : (r += e.bottom),
        this.containerBottomIsNotVisible(r, A))
      ) {
        let A = -1 * this.options.offsetTop;
        this.options.fixMentionsToQuill || (A += e.top), (r = A - t);
      }
      (this.mentionContainer.style.top = `${r}px`),
        (this.mentionContainer.style.left = `${n}px`),
        (this.mentionContainer.style.visibility = "visible");
    }
    setCursorPos() {
      const A = this.quill.getSelection();
      A
        ? (this.cursorPos = A.index)
  ...
  (t.Keys = { TAB: 9, ENTER: 13, ESCAPE: 27, UP: 38, DOWN: 40 }),
    (t.numberIsNaN = (A) => A != A),
    Quill.register("modules/mention", t);
  class r {
    static escape(A) {
      let e = A;
      for (const [A, t] of Object.entries(this.escapeMap))
  ...
  class n {
    constructor(A, e = {}) {
      if (!(A instanceof Node))
        throw "Can't initialize VanillaTilt because " + A + " is not a Node.";
      (this.width = null),
        (this.height = null),
        (this.left = null),
        (this.top = null),
    ...
    setTransition() {
      this.transitionTimeout && clearTimeout(this.transitionTimeout),
        (this.element.style.transition =
          "transform .4s cubic-bezier(0,0,.2,1)"),
        this.glare &&
  ...
  var U,
    ...
    eA = function (A, e, t, r, n) {
      ...
      if ((-1 !== G.indexOf(c) && B === v) || (-1 !== G.indexOf(B) && c === v))
        return "×";
      if (
        (B === R && -1 !== [_, O, S].indexOf(c)) ||
        (-1 !== [_, O, S].indexOf(B) && c === L)
      )
        return "×";
      if (
        (-1 !== G.indexOf(B) && -1 !== Y.indexOf(c)) ||
        (-1 !== Y.indexOf(B) && -1 !== G.indexOf(c))
      )
        return "×";
      if (
        (-1 !== [R, L].indexOf(B) &&
          (c === v || (-1 !== [I, f].indexOf(c) && e[o + 1] === v))) ||
        (-1 !== [I, f].indexOf(B) && c === v) ||
        (B === v && -1 !== [v, y, T].indexOf(c))
      )
        return "×";
      ...
      if (
        (x === B && -1 !== [x, P, M, D].indexOf(c)) ||
        (-1 !== [P, M].indexOf(B) && -1 !== [P, V].indexOf(c)) ||
        (-1 !== [V, D].indexOf(B) && c === V)
      )
        return "×";
      if (
        (-1 !== j.indexOf(B) && -1 !== [K, L].indexOf(c)) ||
        (-1 !== j.indexOf(c) && B === R)
      )
        return "×";
      ...
      if (
        (-1 !== G.concat(v).indexOf(B) && c === I) ||
        (-1 !== G.concat(v).indexOf(c) && B === p)
      )
        return "×";
      if (41 === B && 41 === c) {
    ...
    OA = (function () {
      ...
      return (
        ...
        (A.prototype.consumeToken = function () {
          ...
          switch (A) {
            ...
            case 42:
              ...
              break;
            case 43:
              if (QA(A, this.peekCodePoint(0), this.peekCodePoint(1)))
        ...
        (A.prototype.consumeUnicodeRangeToken = function () {
          for (var A = [], e = this.consumeCodePoint(); sA(e) && A.length < 6; )
        ...
        (A.prototype.consumeUrlToken = function () {
          ...
          for (;;) {
            ...
            if (-1 === r || 41 === r)
              return { type: U.URL_TOKEN, value: u.apply(void 0, A) };
            if (iA(r))
              return (
                this.consumeWhiteSpace(),
                -1 === this.peekCodePoint(0) || 41 === this.peekCodePoint(0)
                  ? (this.consumeCodePoint(),
                    { type: U.URL_TOKEN, value: u.apply(void 0, A) })
                  : (this.consumeBadUrlRemnants(), NA)
              );
            if (34 === r || 39 === r || 40 === r || aA(r))
              return this.consumeBadUrlRemnants(), NA;
            if (92 === r) {
              if (!cA(r, this.peekCodePoint(0)))
                return this.consumeBadUrlRemnants(), NA;
        ...
        (A.prototype.consumeEscapedCodePoint = function () {
          var A = this.consumeCodePoint();
          if (sA(A)) {
            for (var e = u(A); sA(this.peekCodePoint(0)) && e.length < 6; )
              e += u(this.consumeCodePoint());
  ...
  var ge,
    ...
    Ee = function (A, e) {
      ...
      for (i = 0; i < n.length; i++) {
        ...
        if (null === c) null === a && (a = i);
          ...
          for (var l = i - a, Q = (c - n[a - 1]) / (l + 1), u = 1; u <= l; u++)
            n[a + u - 1] = Q * u;
          a = null;
        }
      }
    ...
    Ie = {
      get SUPPORT_RANGE_BOUNDS() {
        ...
        return (
          Object.defineProperty(Ie, "SUPPORT_RANGE_BOUNDS", { value: A }), A
        );
      },
      get SUPPORT_SVG_DRAWING() {
        ...
        return (
          Object.defineProperty(Ie, "SUPPORT_SVG_DRAWING", { value: A }), A
        );
      },
                  ...
                  me(s)
                    .then(function (e) {
                      ...
                      return (
                        ...
                        Ne(r) ? me(Ke(100, 100, 0, 0, s)) : Promise.reject(!1)
                      );
                    })
                    .then(function (A) {
                      return (
                        t.drawImage(A, 0, 0),
                        Ne(t.getImageData(0, 0, 100, 100).data)
                      );
                    })
                    .catch(function () {
                      return !1;
      ...
      get SUPPORT_CORS_IMAGES() {
        ...
        return (
          Object.defineProperty(Ie, "SUPPORT_CORS_IMAGES", { value: A }), A
        );
      },
      get SUPPORT_RESPONSE_TYPE() {
        var A = "string" == typeof new XMLHttpRequest().responseType;
        return (
          Object.defineProperty(Ie, "SUPPORT_RESPONSE_TYPE", { value: A }), A
        );
      },
                ...
                case 0:
                  return (
                    ...
                    (r =
                      ...
                      Ie.SUPPORT_CORS_XHR &&
                      !t),
                    e || !1 !== this._options.allowTaint || Se(A) || r || t
      ...
      "-webkit-gradient": function (A) {
        ...
        return (
          XA(A).forEach(function (A, e) {
            var n = A[0];
            if (0 === e) {
              if (_A(n) && "linear" === n.value)
                return void (r = ge.LINEAR_GRADIENT);
              if (_A(n) && "radial" === n.value)
                return void (r = ge.RADIAL_GRADIENT);
            }
            if (n.type === U.FUNCTION)
              if ("from" === n.name) {
                ...
                (s = ne(n.values[0])), t.push({ stop: jA, color: s });
          ...
          r === ge.LINEAR_GRADIENT
            ? { angle: (e + re(180)) % re(360), stops: t, type: r }
            : { size: s, shape: n, stops: t, position: [], type: r }
        );
      },
    },
    Ge = {
  ...
  var Fr,
    ...
    vr = (function () {
      ...
      return (
        ...
        (A.prototype.isInlineLevel = function () {
          return (
            Hr(this.display, 4) ||
            Hr(this.display, 33554432) ||
            Hr(this.display, 268435456) ||
            Hr(this.display, 536870912) ||
            Hr(this.display, 67108864) ||
            Hr(this.display, 134217728)
          );
        }),
        A
      );
    ...
    Rr = (function () {
      return function (A) {
        (this.counterIncrement = yr(Nr, A.counterIncrement)),
          (this.counterReset = yr(Kr, A.counterReset));
      };
    })(),
    yr = function (A, e) {
      var t = new OA(),
    ...
    br = (function () {
      return function (A) {
        (this.styles = new vr(window.getComputedStyle(A, null))),
          (this.textNodes = []),
          (this.elements = []),
    ...
    Dr = function (A, e, t) {
      ...
      return (
        n.setStart(A, e),
        n.setEnd(A, e + t),
        c.fromClientRect(n.getBoundingClientRect())
      );
    },
    _r = function (A, e) {
      ...
      for (
        var t,
          r = (function (A, e) {
            ...
            wordBreak:
              e.overflowWrap === Pt.BREAK_WORD ? "break-word" : e.wordBreak,
          }),
          n = [];
        !(t = r.next()).done;
    ...
    Pr = (function () {
      return function (A, e) {
        (this.text = Vr(A.data, e.textTransform)),
          (this.textBounds = Sr(this.text, e, A));
      };
    })(),
    Vr = function (A, e) {
      switch (e) {
    ...
    Zr = function (A) {
      return A.width > A.height
        ? new c(A.left + (A.width - A.height) / 2, A.top, A.height, A.height)
        : A.width < A.height
        ? new c(A.left, A.top + (A.height - A.width) / 2, A.width, A.width)
        : A;
    },
    $r = function (A) {
    ...
    cn = function (A, e, t) {
      for (var r = A.firstChild, n = void 0; r; r = n)
        if (((n = r.nextSibling), hn(r) && r.data.trim().length > 0))
          e.textNodes.push(new Pr(r, e.styles));
        else if (gn(r)) {
          var s = ln(r);
          s.styles.isVisible() &&
            (un(r, s, t) ? (s.flags |= 4) : wn(s.styles) && (s.flags |= 2),
            -1 !== an.indexOf(r.tagName) && (s.flags |= 8),
            e.elements.push(s),
            In(r) || Fn(r) || Tn(r) || cn(r, s, t));
        }
    },
    ln = function (A) {
      return pn(A)
    ...
    Pn = (function () {
      ...
      return (
        (A.prototype.toIFrame = function (A, e) {
          ...
          return (
            o.open(),
            o.write(Gn(document.doctype) + "<html></html>"),
            kn(this.referenceElement.ownerDocument, n, s),
            o.replaceChild(
        ...
        (A.prototype.createStyleClone = function (A) {
          try {
            ...
            if (
              (Te.getInstance(this.options.id).error(
        ...
        (A.prototype.createCanvasClone = function (A) {
          if (this.options.inlineImages && A.ownerDocument) {
            ...
            try {
              ...
              Te.getInstance(this.options.id).info(
        ...
        (A.prototype.cloneNode = function (A) {
          ...
          if (Un(A) && e) {
            ...
            this.referenceElement === A && (this.clonedReferenceElement = t),
              fn(t) && jn(t);
            for (
              var i = this.counters.parse(new Rr(r)),
                o = this.resolvePseudoContent(A, t, n, Fr.BEFORE),
                B = A.firstChild;
              B;
              B = B.nextSibling
            )
              (gn(B) &&
                (mn(B) ||
                  B.hasAttribute("data-html2canvas-ignore") ||
                  ("function" == typeof this.options.ignoreElements &&
                    this.options.ignoreElements(B)))) ||
                ...
                o.content.forEach(function (e) {
                  if (e.type === U.STRING_TOKEN)
                    ...
                    switch (e.value) {
                      case "open-quote":
                        B.appendChild(
                          i.createTextNode(Ir(o.quotes, n.quoteDepth++, !0))
                        );
                        break;
                      case "close-quote":
                        B.appendChild(
                          i.createTextNode(Ir(o.quotes, --n.quoteDepth, !1))
                        );
                    }
                }),
                (B.className = Yn + " " + qn),
    ...
    ss = (function () {
      return function (A) {
        ...
        (this.topLeftBorderBox =
          n > 0 || s > 0
            ? is(t.left, t.top, n, s, $n.TOP_LEFT)
            : new es(t.left, t.top)),
          (this.topRightBorderBox =
            o > 0 || B > 0
              ? is(t.left + U, t.top, o, B, $n.TOP_RIGHT)
              : new es(t.left + t.width, t.top)),
          (this.bottomRightBorderBox =
            c > 0 || l > 0
              ? is(t.left + d, t.top + C, c, l, $n.BOTTOM_RIGHT)
              : new es(t.left + t.width, t.top + t.height)),
          (this.bottomLeftBorderBox =
            u > 0 || w > 0
              ? is(t.left, t.top + E, u, w, $n.BOTTOM_LEFT)
              : new es(t.left, t.top + t.height)),
          ...
          (this.topRightPaddingBox =
            o > 0 || B > 0
              ...
              : new es(t.left + t.width - f, t.top + F)),
          (this.bottomRightPaddingBox =
            c > 0 || l > 0
              ? is(
                  t.left + Math.min(d, t.width - p),
                  t.top + Math.min(C, t.height + F),
                  Math.max(0, c - f),
                  l - H,
                  $n.BOTTOM_RIGHT
                )
              : new es(t.left + t.width - f, t.top + t.height - H)),
          (this.bottomLeftPaddingBox =
            u > 0 || w > 0
              ...
              : new es(t.left + p, t.top + t.height - H)),
          (this.topLeftContentBox =
            n > 0 || s > 0
              ...
              : new es(t.left + p + I, t.top + F + N)),
          (this.topRightContentBox =
            o > 0 || B > 0
              ? is(
                  t.left + Math.min(U, t.width + p + I),
                  t.top + F + N,
                  U > t.width + p + I ? 0 : o - p + I,
                  B - (F + N),
                  $n.TOP_RIGHT
                )
              : new es(t.left + t.width - (f + K), t.top + F + N)),
          (this.bottomRightContentBox =
            c > 0 || l > 0
              ? is(
                  t.left + Math.min(d, t.width - (p + I)),
                  t.top + Math.min(C, t.height + F + N),
                  Math.max(0, c - (f + K)),
                  l - (H + m),
                  $n.BOTTOM_RIGHT
                )
          ...
          (this.bottomLeftContentBox =
            u > 0 || w > 0
              ...
              : new es(t.left + p + I, t.top + t.height - (H + m)));
      };
    })();
  !(function (A) {
  ...
  var is = function (A, e, t, r, n) {
      ...
      function A(A, e) {
        ...
        if (A.styles.overflowX !== bt.VISIBLE) {
          var s = os(this.curves),
            i = Bs(this.curves);
          As(s, i)
            ? this.effects.push(new cs(s, 6))
            : (this.effects.push(new cs(s, 2)),
              this.effects.push(new cs(i, 4)));
        }
      }
      return (
          ...
          if (
            ...
            if (l < 0) {
              ...
              a.negativeZIndex.some(function (A, e) {
                return (
                  l > A.element.container.styles.zIndex.order && ((Q = e), !0)
                );
              }),
              ...
              a.positiveZIndex.some(function (A, e) {
                return (
                  l > A.element.container.styles.zIndex.order &&
                  ((u = e + 1), !0)
                );
              }),
    ...
    ws = function (A, e) {
      for (
        var t = A instanceof Yr ? A.start : 1,
          r = A instanceof Yr && A.reversed,
          n = 0;
        n < e.length;
        n++
      ) {
        var s = e[n];
        s.container instanceof Wr &&
          "number" == typeof s.container.value &&
          0 !== s.container.value &&
          (t = s.container.value),
          (s.listValue = xn(t, s.container.styles.listStyleType, !0)),
          (t += r ? -1 : 1);
      }
    },
    hs = function (A, e, t, r) {
      var n = [];
      return (
        ns(A) ? n.push(A.subdivide(0.5, !1)) : n.push(A),
        ns(t) ? n.push(t.subdivide(0.5, !0)) : n.push(t),
        ns(r) ? n.push(r.subdivide(0.5, !0).reverse()) : n.push(r),
        ns(e) ? n.push(e.subdivide(0.5, !1).reverse()) : n.push(e),
        n
      );
    },
    gs = function (A) {
    ...
    Cs = function (A, e, t) {
      ...
      return [
        Hs(fs(A.styles.backgroundRepeat, e), B, s, r, n),
    ...
    Fs = function (A, e, t) {
      ...
      var B = Es(s);
      if (_A(i) && (i.value === Ye.CONTAIN || i.value === Ye.COVER))
        return Es(s)
          ? t.width / t.height < s != (i.value === Ye.COVER)
            ? [t.width, t.width / s]
            : [t.height * s, t.height]
          : [t.width, t.height];
      var a = Es(r),
      ...
      if (B) {
        var Q = 0,
          u = 0;
        return (
          kA(i) ? (Q = $A(i, t.width)) : kA(o) && (u = $A(o, t.height)),
          ds(i) ? (Q = u * s) : (o && !ds(o)) || (u = Q / s),
          [Q, u]
        );
      }
      var w = null,
          ...
          return B(this, void 0, void 0, function () {
            ...
            return a(this, function (a) {
              switch (a.label) {
                ...
                case 1:
                  return s < i.length
                    ? ((o = i[s]), [4, this.renderTextNode(o, n)])
                    : [3, 4];
                case 2:
                  a.sent(), (a.label = 3);
                case 3:
                ...
                case 6:
                  return (
                    (h = a.sent()), this.renderReplacedElement(t, r, h), [3, 8]
                  );
                case 7:
                  return (
                    a.sent(),
                ...
                case 10:
                  return (
                    (h = a.sent()), this.renderReplacedElement(t, r, h), [3, 12]
                  );
                case 11:
                  return (
                    a.sent(),
                ...
                case 14:
                  if (
                    (t instanceof rn &&
                      ...
                      t.type === An
                        ? t.checked &&
                          ...
                          this.path([
                            new es(
                              t.bounds.left + 0.39363 * l,
                              t.bounds.top + 0.79 * l
                            ),
                            new es(
                              t.bounds.left + 0.16 * l,
                              t.bounds.top + 0.5549 * l
                            ),
                            new es(
                              t.bounds.left + 0.27347 * l,
                              t.bounds.top + 0.44071 * l
                            ),
                            new es(
                              t.bounds.left + 0.39694 * l,
                              t.bounds.top + 0.5649 * l
                            ),
                            new es(
                              t.bounds.left + 0.72983 * l,
                              t.bounds.top + 0.23 * l
                            ),
                            new es(
                              t.bounds.left + 0.84 * l,
                              t.bounds.top + 0.34085 * l
                            ),
                            new es(
                              t.bounds.left + 0.39363 * l,
                              t.bounds.top + 0.79 * l
                    ...
                    (u = C.add(Q, 0, 0, -C.height / 2 + 1)),
                      ...
                      this.path([
                        new es(C.left, C.top),
                        new es(C.left + C.width, C.top),
                        new es(C.left + C.width, C.top + C.height),
                        new es(C.left, C.top + C.height),
                      ]),
                      this.ctx.clip(),
                  ...
                  if ((w = t.styles.listStyleImage).type !== ge.URL)
                    return [3, 18];
                      ...
                      return a(this, function (a) {
                        switch (a.label) {
                          ...
                          case 3:
                            return (
                              a.sent(),
                              Te.getInstance(r.options.id).error(
                          ...
                          case 5:
                            t.type === ge.LINEAR_GRADIENT
                              ...
                              : (function (A) {
                                ...
                                (p = d[4]),
                                (N =
                                  0 === t.position.length ? [qA] : t.position),
                                (K = $A(N[0], H)),
                                (m = $A(N[N.length - 1], p)),
          ...
          return B(this, void 0, void 0, function () {
            ...
            return a(this, function (a) {
              switch (a.label) {
                ...
                case 3:
                  return i < o.length
                    ? (B = o[i]).style === Ze.NONE || se(B.color)
                      ? [3, 5]
                      : [4, this.renderBorder(B.color, s++, A.curves)]
                    : [3, 6];
                case 4:
                  a.sent(), (a.label = 5);
                case 5:
    ...
    Ks = function (A) {
      return (
        A instanceof sn ||
        A instanceof nn ||
        (A instanceof rn && A.type !== en && A.type !== An)
      );
    },
    ms = function (A, e) {
      switch (A) {
        ...
        return a(this, function (a) {
          switch (a.label) {
            case 0:
              ...
              return (
                (n = (Math.round(1e3 * Math.random()) + Date.now()).toString(
                  16
                )),
                (s =
                  fn(A) || "HTML" === A.tagName
            ...
            case 1:
              return (
                (E = a.sent()),
                (F = t.documentElement
                  ? Ls(getComputedStyle(t.documentElement).backgroundColor)
                  : he.TRANSPARENT),
                (f = t.body
                  ? Ls(getComputedStyle(t.body).backgroundColor)
                  : he.TRANSPARENT),
                (H = e.backgroundColor),
                (p = "string" == typeof H ? Ls(H) : 4294967295),
                (N =
                  A === t.documentElement ? (se(F) ? (se(f) ? p : f) : F) : p),
                (K = {
                  id: n,
                  cache: g.cache,
                  backgroundColor: N,
            ...
            case 3:
              return (
                ...
                (I = Qn(d)),
                ve.detachInstance(),
                N === I.styles.backgroundColor &&
                  (I.styles.backgroundColor = he.TRANSPARENT),
    ...
    constructor(e) {
      ...
      (this.div = document.querySelector(`div.modal.${e}`)),
        ...
        this.div.addEventListener("click", (e) => {
          e.target === this.div &&
            (A.debug("modal:background.click"), this.hide());
        });
    }
    async show() {
  ...
  class Ms extends Ss {
    constructor() {
      super("share-screenshot"),
        (this.imResult = this.div.querySelector(".js-result"));
    }
    ...
    async performShow() {
      ...
      const A = document.querySelector("div.page-inner"),
        e = await Rs(A, {
          logging: !1,
          onclone: (A) => {
            A.querySelector("div.page-inner").classList.add("html2canvas"),
              (A.querySelector("div.watermark").style.visibility = "visible");
          },
        });
  ...
  class Ds extends Ss {
    constructor(A) {
      super("save-publish"),
        (this.quill = A),
        (this.saveBtn = this.div.querySelector(".js-save")),
  ...
  !(function (A) {
    (A[(A.app = 0)] = "app"),
      (A[(A.landing = 1)] = "landing"),
      (A[(A.model = 2)] = "model");
  })(ys || (ys = {}));
  const _s = {
      page: document.body.classList.contains("app")
        ? ys.app
  ...
  _s.onLoad(ys.app, () => {
    ...
    //   a.container.appendChild(_s.shareScreenBtn),
      ...
      a.keyboard.bindings[t.Keys.TAB].unshift(
        a.keyboard.bindings[t.Keys.TAB].pop()
      );
    const Q = async () => {
      c.setCursorPos();
      const t = a.getBounds(c.getCursorPos());
      (_s.loaderEditor.style.top = `${t.top - 4}px`),
        (_s.loaderEditor.style.left = `${t.left + 4}px`),
        _s.loaderEditor.classList.remove("hide");
    ...
    //   A.preventDefault(),
    //     a.setText(r.randomItem(xs)),
    //     a.setSelection(a.getLength(), 0),
    //     Q();
    // }),
    ...
    //   }),
      a.on("text-change", () => {
        ...
        const A = a
          .getContents()
          .ops.some((A) => A.attributes && !0 === A.attributes.bold);
      ...
      document.addEventListener("click", (e) => {
        if (
          !(
            ...
            null !== e.target.closest("div.ql-editor")
          )
        )
          return;
    ...
    const w = (A) => {
      const e = A.parentNode.querySelector(".js-val"),
        t = Number.isInteger(A.valueAsNumber)
          ? A.valueAsNumber
          : Number(A.valueAsNumber.toFixed(2)),
        r = `value-${t}`;
      A.dataset[r]
        ? (e.innerText = A.dataset[r])
      ...
      (e.className =
        t < n + (s - n) / 3
          ...
          ? "js-val orange"
          : "js-val red"),
        A.classList.contains("js-inverted") &&
          (e.classList.contains("green")
            ? (e.classList.remove("green"), e.classList.add("red"))
            : e.classList.contains("red") &&
              (e.classList.remove("red"), e.classList.add("green")));
    };
